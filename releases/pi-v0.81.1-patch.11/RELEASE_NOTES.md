...
- Strict model hydration no longer requires eight OpenAI API models shut down on 2026-07-23, their derived Azure catalog entries, or four identities withdrawn from the live Vercel AI Gateway catalog on 2026-07-24 (`anthropic/claude-opus-4.7-fast`, `google/gemini-3.1-flash-lite-preview`, `openai/gpt-5-chat`, and `openai/gpt-5.2-chat`); every remaining committed identity stays release-gated against the live catalogs.
